...
const ListItemCard = ({
  ...
  const renderBtnType = () => {
    if (isAuthorized) {
      return (
        <div
          className={styles.channeltypeWrapper}
      ...
      return <span className={styles.warning}>you should be authorized</span>;
    }
  };
  return (
    <>
        ...
        <div className={styles.cardItem}>
          <div className={styles.container}>
            ...
            <div className={styles.cardDetails}>
              <p className={channeltype ? styles.channelTitle : styles.title}>
                {name}
              </p>
              {/* optional */}
              {(startDate || endDate) && (
